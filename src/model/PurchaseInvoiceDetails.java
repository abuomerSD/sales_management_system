...
public class PurchaseInvoiceDetails {
    ...
    public String toString() {
        return "PurchaseInvoiceDetails{" + "id=" + id + ", colNumber=" + colNumber + ", productCode=" + productCode + ", productName=" + productName + ", productQTY=" + productQTY + ", productCost=" + productCost + ", productTotalCost=" + productTotalCost + '}';
    }
